...
There is a basic, responsive stylesheet included with the plugin so everyone can get started with minimal set up, even if not using a supported theme. While you can technically have “unlimited” columns of pricing tables, the default stylesheet will only account for a maximum of five per set.

= Ideal for theme developers =
...
4. Use the arrow buttons to reorder the plans, if necessary.
...
If you’re not a user of a theme that advertises support for Pricing Tables Pro, there are probably better fits for you in the pricing table plugin realm. If you are, you can likely get support from whoever sold you the theme.
...
However, we realize that the plugin in its current state could be more flexible through the use of action hooks and filters. If you’re a developer and willing to contribute such changes, please submit a pull request on the [Pricing Tables Pro GitHub page](https://github.com/metrocraft/pricing-tables-pro).
...
Sure! Please check out the [Pricing Tables Pro GitHub page](https://github.com/metrocraft/pricing-tables-pro)
...
1. This is a screenshot of the pricing tables using the included CSS styles.
2. Manage your various pricing tables through a familiar interface.
3. A pricing table with two plans.
4. Individual plan settings (1 of 2). Set your price, currency, caption, and plan title.
5. Individual plan settings (2 of 2). List features, call to action text, and link. Sorting options at the bottom.
6. Include your pricing tables anywhere with a simple shortcode embed.
